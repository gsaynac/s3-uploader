...
exports.default = function (file, arg) {
  var _id, acl, authorizer, bucket, encoding, expiration, extension, file_data, file_name, path, ref, ref1, ref2, ref3, ref4, region, upload_event;
  _id = (ref = arg._id) != null ? ref : (0, _v2.default)(), encoding = (ref1 = arg.encoding) != null ? ref1 : "", file_name = (ref2 = arg.file_name) != null ? ref2 : true, authorizer = arg.authorizer, path = arg.path, acl = arg.acl, bucket = arg.bucket, region = arg.region, expiration = arg.expiration, upload_event = (ref3 = arg.upload_event) != null ? ref3 : _noop2.default;
  if (!authorizer) {
